      ...
      <div class="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        <a href="index.html" class="flex items-center gap-3">
          ...
          <div>
            ...
            <span class="text-xs text-zinc-400 block -mt-0.5">AI Product Design Leader + Design Engineer</span>
          </div>
        </a>
        
        <nav class="hidden md:flex items-center gap-1 bg-zinc-900/90 p-1 rounded-full border border-zinc-800">
          <a href="index.html#featured" class="px-4 py-1.5 text-xs font-medium text-zinc-400 hover:text-white transition">Featured Work</a>
          <a href="index.html#all-projects" class="px-4 py-1.5 text-xs font-medium text-zinc-400 hover:text-white transition">All Case Studies</a>
